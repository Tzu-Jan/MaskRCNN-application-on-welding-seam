...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/content/drive/MyDrive/Research/Thesis/Training/Project/main/Mask_RCNN-TF2/Datasets/train",
                        help='/content/drive/MyDrive/mask_rcnn/Mask_RCNN-TF2/Datasets')
    parser.add_argument('--weights', required=True,
                        metavar="/content/drive/MyDrive/My Drive/Research/Thesis/Training/Project/main/logs/weights.h5",
                        help="/content/drive/MyDrive/My Drive/Research/Thesis/Training/Project/main/Mask_RCNN-TF2/mask_rcnn_coco.h5")
